...
my $cfg = Config::IniFiles->new(-file => 'sweetiebot.ini');

# --- Create and start bot ---

print "Initializing bot\n";

my $bot = SweetieBot->new(
...
sub loadModule {
	...
	my $modulePackage = ("SweetieBot::Module::" . ucfirst($module));
...
sub leave_channel {
	...
	$part_msg ||= ('Forcing Shutdown of Cutie Mark Acquisition Program v1.0');
